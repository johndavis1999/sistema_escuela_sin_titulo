...
// Verificar si la variable "idrepresentante" está definida
...
// Crear la consulta para actualizar los datos del alumno en la base de datos
...
// Redirije a la pagina alumno una vez terminado de correr el script
echo "<script type='text/javascript'>
        window.location='../consultaAlumnos.php';
    </script>";
?>
