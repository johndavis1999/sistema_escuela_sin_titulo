<!-- Modal creacion de Representante -->
<div class="modal fade" id="createChildresn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form name="form-data" action="componentes/recibRepresentantes.php" method="POST" enctype="multipart/form-data">
        <div class="modal-body" id="cont_modal">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" name="nombres" pattern='[A-Z a-z Ñ ñ á é í ó ú Á É Í Ó Ú]*$' autofocus required>
                </div>
                <!-- Campos apellidos -->
                <div class="col-md-12">
