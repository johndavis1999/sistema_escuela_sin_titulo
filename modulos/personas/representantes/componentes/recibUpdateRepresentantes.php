...
// Crear la consulta para actualizar los datos del representante en la base de datos
...
// Redirije a la pagina representante una vez terminado de correr el script
echo "<script type='text/javascript'>
        window.location='../consultaRepresentantes.php';
    </script>";
?>
