        ...
        <div class="modal-body" id="cont_modal">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" name="nombres" pattern='[A-Z a-z Ñ ñ á é í ó ú Á É Í Ó Ú]*$'   autofocus  >
                </div>
                <!-- Campos apellidos -->
                <div class="col-md-12">
                    <label for="apellidos" class="form-label">Apellidos</label>
                    <input type="text" class="form-control" name="apellidos" pattern='[A-Z a-z Ñ ñ á é í ó ú Á É Í Ó Ú]*$'  >
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" name="identificacion" id="identificacion"  pattern = "[0-9]{10,13}"   >
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" name="celular" pattern = "[0-9]{5,13}"  >
                </div>
