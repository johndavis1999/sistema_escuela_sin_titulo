...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/sintitulo/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="/sintitulo/css/stylenav.css">
      ...
      <ul class="nav-links">
          ...
          <li>
            ...
            <ul class="sub-menu">
              ...
              <li><a href="/sintitulo/modulos/personas/docentes/consultaDocentes.php">Docentes</a></li>
              <li><a href="/sintitulo/modulos/personas/alumnos/consultaAlumnos.php">Alumnos</a></li>
              <li><a href="/sintitulo/modulos/personas/representantes/consultaRepresentantes.php">Representantes</a></li>
              <li><a href="#">Todos</a></li>
            </ul>
          </li>
          <hr class="sidebar-divider">
          <li>
            <a href="/sintitulo/modulos/cursos/consultacursos.php">
              <i class='bx bxs-graduation' ></i>
              <span class="link_name">Cursos</span>
            </a>
            <ul class="sub-menu blank">
              <li><a class="link_name" href="/sintitulo/modulos/cursos/consultacursos.php">Cursos</a></li>
            </ul>
          </li>
          <hr class="sidebar-divider">
          <li>
            <a href="/sintitulo/modulos/materias/consultaMaterias.php">
              <i class='bx bx-spreadsheet'></i>
              <span class="link_name">Materias</span>
            </a>
            <ul class="sub-menu blank">
              <li><a class="link_name" href="/sintitulo/modulos/materias/consultaMaterias.php">Materias</a></li>
            </ul>
          </li>
          <hr class="sidebar-divider">
          <li>
